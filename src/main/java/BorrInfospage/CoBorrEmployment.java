	...
	public class CoBorrEmployment {

		@FindBy(how = How.XPATH, using = "//h4[text() ='Employment']//following::button[text()='Add'][2]")
		...
		WebElement EndDate;
		@FindBy(how = How.XPATH, using = "//label[text() ='Length of Employment']//following::span[2]/input[1] ")
		WebElement Years;
