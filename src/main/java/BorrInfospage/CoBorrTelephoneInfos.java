...
public class CoBorrTelephoneInfos {

	
	@FindBy(how =How.XPATH ,using ="//h4[text() ='Telephone']//following::button[text()='Add'][2]")
	 ...
	 public void CoBorrADD_Button() {
		 AddButton.click();
	 }
	 public void coborrtelepnone(String telephonetype ,String otherdescription,String number ,String extention ,String action) throws InterruptedException {
