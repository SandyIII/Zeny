...
public class CoBorrowerDeclarations {
	...
	@FindBy(how = How.XPATH, using = "//select[@ng-model = 'selected.borrowerSet.CoBorrower.Declaration.CitizenshipResidencyType']")
	WebElement citizenship_residency_status;
	
	//Do you live in a community property state?
		@FindBy(how = How.XPATH, using = "//select[@ng-model = 'selected.borrowerSet.CoBorrower.Declaration.CommunityPropertyStateResidentIndicator']")
		WebElement property_state;

	// Do you intend to occupy the property as your primary residence?
	@FindBy(how = How.XPATH, using = "//select[@ng-model = 'selected.borrowerSet.CoBorrower.Declaration.IntentToOccupyType']")
	WebElement primary_residence;

	// Have you had an ownership interest in a property in the last three years?
	@FindBy(how = How.XPATH, using = "//select[@ng-model = 'selected.borrowerSet.CoBorrower.Declaration.HomeownerPastThreeYearsType']")
	WebElement ownership_interest;

	// What type of property did you own (PR/SR/SH/IP)?
	@FindBy(how = How.XPATH, using = "//select[@ng-model = 'selected.borrowerSet.CoBorrower.Declaration.PriorPropertyUsageType ']")
	WebElement type_of_property;

	// How did you hold title to home (S/SP/O)?
	@FindBy(how = How.XPATH, using = "//select[@ng-model = 'selected.borrowerSet.CoBorrower.Declaration.PriorPropertyTitleType']")
	...
	//Purchase Transaction: Do you have a family relationship or business affiliation with the seller of the property?
		@FindBy(how = How.XPATH, using = "//select[@ng-model = 'selected.borrowerSet.CoBorrower.Declaration.SpecialBorrowerSellerRelationship.Indicator']")
		WebElement Purchase_Transaction;
		@FindBy(how = How.XPATH, using = "//*[@ng-model = 'selected.borrowerSet.CoBorrower.Declaration.SpecialBorrowerSellerRelationship.Explanation']")
		WebElement Purchase_Transaction_Explanation;
	
	// Is any part of the down payment borrowed?
	@FindBy(how = How.XPATH, using = "//select[@ng-model = 'selected.borrowerSet.CoBorrower.Declaration.BorrowedDownPayment.Indicator']")
	WebElement down_payment_borrowed;
	@FindBy(how = How.XPATH, using = "//*[@ng-model = 'selected.borrowerSet.CoBorrower.Declaration.BorrowedDownPayment.Explanation']")
	WebElement down_payment_borrowed_Explanation;
	@FindBy(how = How.XPATH, using = "//label[text()='Is any part of the down payment borrowed?']//following::input[3]")
	...
	// Have you applied, or will you be applying, for a mortgage loan on another property on or before closing this transaction that is not disclosed on this loan application?
		@FindBy(how = How.XPATH, using = "//select[@ng-model = 'selected.borrowerSet.CoBorrower.Declaration.UndisclosedMortgageApplication.Indicator']")
		WebElement any_Mortgage;
		@FindBy(how = How.XPATH, using = "//*[@ng-model = 'selected.borrowerSet.CoBorrower.Declaration.UndisclosedMortgageApplication.Explanation']")
	...
	//Have you applied, or will you be applying, for any new credit on or before closing this loan that is not disclosed on this loan application?
		@FindBy(how = How.XPATH, using = "//select[@ng-model = 'selected.borrowerSet.CoBorrower.Declaration.UndisclosedCreditApplication.Indicator']")
		WebElement any_new_credit;
		@FindBy(how = How.XPATH, using = "//*[@ng-model = 'selected.borrowerSet.CoBorrower.Declaration.UndisclosedCreditApplication.Explanation']")
		...
		@FindBy(how = How.XPATH, using = "//select[@ng-model = 'selected.borrowerSet.CoBorrower.Declaration.PropertyProposedCleanEnergyLien.Indicator']")
		WebElement first_mortgage_lien;
		@FindBy(how = How.XPATH, using = "//*[@ng-model = 'selected.borrowerSet.CoBorrower.Declaration.PropertyProposedCleanEnergyLien.Explanation']")
		...
		@FindBy(how = How.XPATH, using = "//select[@ng-model = 'selected.borrowerSet.CoBorrower.Declaration.UndisclosedComakerOfNote.Indicator']")
		WebElement co_signer_or_guarantor;
		@FindBy(how = How.XPATH, using = "//*[@ng-model = 'selected.borrowerSet.CoBorrower.Declaration.UndisclosedComakerOfNote.Explanation']")
		WebElement co_signer_or_guarantor_Explanation;

	// Are you obligated to pay alimony, child support or separate maintenance?
	@FindBy(how = How.XPATH, using = "//select[@ng-model = 'selected.borrowerSet.CoBorrower.Declaration.AlimonyChildSupportObligation.Indicator']")
	WebElement child_support_or_separate_maintenance;
	@FindBy(how = How.XPATH, using = "//*[@ng-model = 'selected.borrowerSet.CoBorrower.Declaration.AlimonyChildSupportObligation.Explanation']")
	WebElement child_support_or_separate_maintenance_Explanation;

	// Are you a co-maker or endorser on a note?
	@FindBy(how = How.XPATH, using = "//select[@ng-model = 'selected.borrowerSet.CoBorrower.Declaration.CoMakerEndorserOfNote.Indicator']")
	WebElement co_maker_or_endorser;
	@FindBy(how = How.XPATH, using = "//*[@ng-model = 'selected.borrowerSet.CoBorrower.Declaration.CoMakerEndorserOfNote.Explanation']")
	WebElement co_maker_or_endorser_Explanation;

	// Are there any outstanding judgments against you?
	@FindBy(how = How.XPATH, using = "//select[@ng-model = 'selected.borrowerSet.CoBorrower.Declaration.OutstandingJudgments.Indicator']")
	WebElement outstanding_judgments_against_you;
	@FindBy(how = How.XPATH, using = "//*[@ng-model = 'selected.borrowerSet.CoBorrower.Declaration.OutstandingJudgments.Explanation']")
	...
	@FindBy(how = How.XPATH, using = "//select[@ng-model = 'selected.borrowerSet.CoBorrower.Declaration.PresentlyDelinquent.Indicator']")
	WebElement Are_you_presently_delinquent;
	@FindBy(how = How.XPATH, using = "//*[@ng-model = 'selected.borrowerSet.CoBorrower.Declaration.PresentlyDelinquent.Explanation']")
	WebElement Are_you_presently_delinquent_Explanation;

	// Are you a party to a lawsuit?
	@FindBy(how = How.XPATH, using = "//select[@ng-model = 'selected.borrowerSet.CoBorrower.Declaration.PartyToLawsuit.Indicator']")
	WebElement party_to_a_lawsuit;
	@FindBy(how = How.XPATH, using = "//*[@ng-model = 'selected.borrowerSet.CoBorrower.Declaration.PartyToLawsuit.Explanation']")
	...
	@FindBy(how = How.XPATH, using = "//select[@ng-model = 'selected.borrowerSet.CoBorrower.Declaration.PriorPropertyDeedInLieuConveyed.Indicator']")
	WebElement conveyed_title_obligated;
	@FindBy(how = How.XPATH, using = "//*[@ng-model = 'selected.borrowerSet.CoBorrower.Declaration.PriorPropertyDeedInLieuConveyed.Explanation']")
	...
	//Have you completed a pre-foreclosure sale or short sale within the last seven years?
			@FindBy(how = How.XPATH, using = "//select[@ng-model = 'selected.borrowerSet.CoBorrower.Declaration.PriorPropertyShortSaleCompleted.Indicator']")
			WebElement Have_you_ompleted_a_pre_foreclosure;
			@FindBy(how = How.XPATH, using = "//*[@ng-model = 'selected.borrowerSet.CoBorrower.Declaration.PriorPropertyShortSaleCompleted.Explanation']")
			WebElement Have_you_ompleted_a_pre_foreclosure_Explanation;

	// Have you been obligated on any loan which resulted in foreclosure, transfer of title in lieu of foreclosure, or judgment?
	@FindBy(how = How.XPATH, using = "//select[@ng-model = 'selected.borrowerSet.CoBorrower.Declaration.LoanForeclosureOrJudgment.Indicator']")
	WebElement Have_you_been_obligated;
	@FindBy(how = How.XPATH, using = "//*[@ng-model = 'selected.borrowerSet.CoBorrower.Declaration.LoanForeclosureOrJudgment.Explanation']")
	WebElement Have_you_been_obligated_Explanation;

	// Have you had property foreclosed upon within the last seven years?
	@FindBy(how = How.XPATH, using = "//select[@ng-model = 'selected.borrowerSet.CoBorrower.Declaration.PropertyForeclosedPastSevenYears.Indicator']")
	WebElement property_foreclosed;
	@FindBy(how = How.XPATH, using = "//*[@ng-model = 'selected.borrowerSet.CoBorrower.Declaration.PropertyForeclosedPastSevenYears.Explanation']")
	WebElement property_foreclosed_Explanation;

	// Have you declared bankruptcy within the last seven years?
	@FindBy(how = How.XPATH, using = "//select[@ng-model = 'selected.borrowerSet.CoBorrower.Declaration.Bankruptcy.Indicator']")
	WebElement declared_bankruptcy;
	@FindBy(how = How.XPATH, using = "//*[@ng-model = 'selected.borrowerSet.CoBorrower.Declaration.Bankruptcy.Explanation']")
	WebElement declared_bankruptcy_Explanation;
	@FindBy(how = How.XPATH, using = "//*[@ng-model = 'selected.borrowerSet.CoBorrower.Bankruptcy.Bankruptcy_Details']")
	...
	public void Co_borrower_declarations1(String status, String propertystate , String resident, String interest, String type, String title ,String purchase ,String purchase_explication)
	...
	public void Co_borrower_declarations2(String down_yes_No, String borrowed_Explanation, String amount ,String mortgage ,String mortgageexplication,String credit ,
