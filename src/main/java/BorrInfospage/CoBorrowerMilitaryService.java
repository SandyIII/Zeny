...
public class CoBorrowerMilitaryService {
	@FindBy(how = How.XPATH, using = "//select[@ng-model ='selected.borrowerSet.CoBorrower.Government.VA.Military_Service.SelfDeclaredMIlitaryServiceIndicator']")
	WebElement YES_NO;
	@FindBy(how = How.XPATH, using = "//*[@ng-model ='selected.borrowerSet.CoBorrower.Government.VA.Military_Service']")
	WebElement Select;
