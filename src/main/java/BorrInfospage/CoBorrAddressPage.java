...
public class CoBorrAddressPage {

	
	
	@FindBy(how =How.XPATH ,using ="//h4[text() ='Address']//following::button[text()='Add'][2]")
	 ...
	 public void Add_Button() {
		 AddButton.click();}
	 public void Coborr_addrees(String addresstype, String occupancy ,String monthlyrent ,String Year ,String Months ,String address, 
