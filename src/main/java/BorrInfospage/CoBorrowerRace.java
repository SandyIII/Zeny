...
public class CoBorrowerRace {
	...
	WebElement cancel;
	@FindBy(how = How.XPATH, using = "//*[@ng-model ='selected.borrowerSet.CoBorrower.GovernmentMonitoring.RaceNationalOriginRefusalIndicator']")
	WebElement Borrower_ChechBox;
	@FindBy(how = How.XPATH, using = "//select[@ng-model ='selected.borrowerSet.CoBorrower.GovernmentMonitoring.HMDARaceCollectedBasedOnVisualObservationOrSurnameIndicator']")
